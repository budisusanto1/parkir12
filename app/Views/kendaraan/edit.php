...
<div class="form-container">
    <div class="kendaraan-form">
        <div class="form-header">
            <h3 class="mb-0">Edit Kendaraan</h3>
            <p class="mb-0 opacity-75">Ubah data kendaraan</p>
        </div>
        
        <form action="<?= site_url('/kendaraan/update/' . $kendaraan['id_kendaraan']) ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="jenis_kendaraan" name="jenis_kendaraan" required>
                    ...
                    <option value="motor" <?= $kendaraan['jenis_kendaraan'] === 'motor' ? 'selected' : '' ?>>🏍️ Motor</option>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="warna" name="warna" 
                       value="<?= $kendaraan['warna'] ?>" placeholder="Contoh: Merah, Hitam, Silver">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control" id="pemilik" name="pemilik" 
                       value="<?= $kendaraan['pemilik'] ?>" placeholder="Opsional">
            </div>
