...
<head>
    ...
    <title>Struk Masuk Parkir - <?= $transaksi['plat_nomor'] ?? 'N/A' ?></title>
    ...
    <div class="struk-container">
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <span><?= $transaksi['nama_area'] ?? 'Umum' ?></span>
            </div>
        ...
        <div class="footer">
            ...
            <p>Tiket diperlukan saat keluar</p>
            <p>*Tiket ini sah sebagai bukti masuk*</p>
        </div>
    </div>
    
    <div class="no-print">
        <button onclick="window.print()">
            <i class="fas fa-print"></i> Cetak Tiket Masuk
        </button>
